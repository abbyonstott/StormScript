...
g++ ../core/parse.cpp ../core/sts.cpp ../values/stsdec.cpp ../stream/stsstream.cpp ../stream/io.cpp -o linux-x86/bin/sts
...
x86_64-w64-mingw32-g++ ../core/parse.cpp ../core/sts.cpp ../values/stsdec.cpp ../stream/stsstream.cpp ../stream/io.cpp  -o release/windows-x86/bin/sts.exe -static-libgcc -static-libstdc++
